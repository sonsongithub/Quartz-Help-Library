...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
	[cell.textLabel setText:NSLocalizedString(@"test", nil)];
...
{
	QuartzHelpLibraryViewController *con = [[QuartzHelpLibraryViewController alloc] initWithNibName:nil bundle:nil];
